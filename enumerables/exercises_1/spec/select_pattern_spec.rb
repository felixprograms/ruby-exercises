RSpec.describe 'select pattern' do
  ...
  it 'words with three letters' do
    ...
    words.each do |number|
      # Your code goes here
      selected << number if number.length == 3
    end
  ...
  it 'words ending in ing' do
    ...
    words.each do |number|
      # Your code goes here
      selected << number if number[-3..-1] == "ing"
    end   
  ...
  it 'words containing e' do
    ...
    words.each do |number|
      # Your code goes here
      selected << number if number.include?("e")
    end
  ...
  it 'dinosaurs' do
    ...
    # Your code goes here
    dinosaurs = []
    animals.each do |number|
      # Your code goes here
      dinosaurs << number if number[-6..-1] == "saurus"
    end   
  ...
  it 'floats' do
    ...
    numbers.each do |number|
      # Your code goes here
      floats << number if number.class.name == "Float"
    end
  ...
  it 'arrays' do
    ...
    elements.each do |number|
      # Your code goes here
      arrays << number if number.class.name == "Array"
    end
  ...
  it 'hashes' do
    ...
    elements.each do |number|
      # Your code goes here
      hashes << number if number.class.name == "Hash"
    end

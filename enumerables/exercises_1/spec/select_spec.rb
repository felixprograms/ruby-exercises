RSpec.describe 'select' do
  ...
  it 'dinosaurs' do
    ...
    dinosaurs = animals.select do |number|
      # Your code goes here
      number[-6..-1] == "saurus"
    end
  ...
  it 'arrays' do
    ...
    arrays = elements.select do |number|
      # Your code goes here
      number.class.name == "Array"
    end
  ...
  it 'hashes' do
    ...
    hashes = elements.select do |number|
      # Your code goes here
      number.class.name == "Hash"
    end

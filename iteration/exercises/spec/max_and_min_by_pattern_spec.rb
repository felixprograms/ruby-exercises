RSpec.describe 'max and min by pattern' do
  ...
  it 'test 6' do
    ...
    # Your Code Here
    stats.each do |start, sat|
      if sat.to_s.length > most_digits.to_s.length
        most_digits = sat
      end
    end
  ...
  it 'test 9' do
    ...
    # Your Code Here
    fewest_programmers = [1,2,2,2,2,2,2,2,2,2,2,2]
  ...
  it 'test 10' do
    ...
    # Your Code Here
    fewest_programmers = [1,1,1,1,3,3,5,5,5]
    programmers.each do |group,pro|
      if pro.length < fewest_programmers.length
        fewest_programmers = group
      end
    end
